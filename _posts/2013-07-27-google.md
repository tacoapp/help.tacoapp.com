...
## Gmail access eliminated on Dec. 31, 2019

**Important notice**: Due to a [policy change by Google](https://cloud.google.com/blog/products/g-suite/elevating-user-trust-in-our-api-ecosystems) ([analysis](https://www.theregister.co.uk/2019/02/11/google_gmail_developer/)), Google will terminate access to the Gmail API for Taco and many other services. Gmail will no longer be supported after December 31, 2019.
