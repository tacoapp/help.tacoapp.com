...
with filter support, a "Filtering Tasks" section will be shown. You'll 
see a set of checkboxes similar to this:
...
include a project name, task labels/tags, or scheduling attributes
(like `today`).
